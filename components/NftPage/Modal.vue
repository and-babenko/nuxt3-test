      ...
      <div ref="modalRef">
        ...
        <div class="flex flex-col items-center gap-4">
          <div class="flex justify-center items-center gap-6 relative">
            ...
            <div
              class="relative max-w-[512px] max-h-[512px] flex justify-center items-center mt-[21px]"
            >
            ...
            <GrayBtn
              class="absolute bottom-[-80px] right-50 backdrop-blur-md"
              @onBtnClick="onOpenShopHandler"
            >
...
const emit = defineEmits(["onClosePopup", "onNextClick, onPrevClick"]);

const modalRef = ref(null);

const onOutsideModalClickHandler = (evt) => {
  if (modalRef.value && !evt.composedPath().includes(modalRef.value)) {
    emit("onClosePopup");
  }
};
